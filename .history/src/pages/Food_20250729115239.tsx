  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        origin: "Vùng đồng bằng sông Cửu Long, bao gồm An Giang",
        image: "/images/Foods/lau-mam.jpg"
      },
      {
        name: "Mắm Ruốc",
              ...
              <TabsContent key={category.id} value={category.id} className="pt-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  {category.items.map((food, index) => (
                    ...
                    >
                      <div className="h-70 bg-gradient-to-br from-amber-100 to-orange-100 flex items-center justify-center relative overflow-hidden">
                        {/* Ảnh món ăn */}
                        <img 
                          src={food.image} 
                          height={90}
