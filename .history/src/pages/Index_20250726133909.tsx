...
const destinations = [
  {
    ...
    images: [
      'https://statics.vinpearl.com/nui-sam-an-giang-01_1630384203.jpg',
      '/images/SamMountain.jpg',
      'https://vcdn1-dulich.vnecdn.net/2022/04/20/1-1607414895-5366-1607415073-6371-1650420677.jpg?w=1200&h=0&q=100&dpr=1&fit=crop&s=nwvsb2wIYlJzKT8ludD5_g',
    ],
    foods: [
      {
  ...
  },
  {
    ...
    images: [
      'https://statics.vinpearl.com/rung-tram-tra-su-0_1630641536.jpg',
      'https://images2.thanhnien.vn/uploaded/minhnhat/2020_09_29/rung-tram-tra-su-9_OVYE.jpg?width=500',
      'https://bizweb.dktcdn.net/100/423/653/files/rung-tra-su-an-giang.jpg?v=1618214671177',
    ],
    foods: [
      {
          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            <div className="hidden lg:block mt-8">
              <div className="rounded-lg overflow-hidden shadow-md">
                <img 
                  src="https://vnn-imgs-a1.vgcloud.vn/icdn.dantri.com.vn/2021/05/26/rung-thot-not-an-giang-1-1622015920442.jpg" 
