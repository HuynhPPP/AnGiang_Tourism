      ...
      <header className="relative bg-green-600 text-white">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">
            Culinary Delights of An Giang
          </h1>
          <p className="mt-6 max-w-2xl mx-auto text-xl">
            Explore the unique flavors and traditional cuisine of Vietnam's western province
          </p>
        </div>
      </header>
          ...
          <div className="md:flex md:items-center md:justify-between">
            <div className="text-center md:text-left">
              ...
              <p className="mt-2 text-sm text-green-200">
                Discover the culinary treasures of Vietnam's western province
              </p>
            </div>
