...
const districts = [
  {
    ...
    image: "/images/LongXuyenImgs/Logo_tỉnh_An_Giang.png",
    ...
    attractions: [
      {
        ...
        image: "https://media.travelmag.vn/files/thuannguyen/2020/04/25/long-xuyen-1-2033.jpeg"
      },
      {
        name: "Chùa cổ nội ô",
  ...
  },
  {
    ...
    image: "https://thanhtra.com.vn/data/images/0/2023/05/04/hungthanh/a1-1.jpg",
  ...
  },
  {
    ...
    image: "https://discoveryindochina.com/wp-content/uploads/2021/09/Dien-Hai-3.jpg",
  ...
  },
  {
    ...
    image: "https://media.suckhoecongdong.vn/Images/thanhtuyen/2019/01/03/lam_sao_de_thu_hut_du_khach_tham_quan.jpg",
    description: "Thị xã Tịnh Biên nằm ở phía tây của tỉnh An Giang, giáp với biên giới Campuchia, nổi tiếng với chợ biên giới và cảnh quan thiên nhiên.",
    attractions: [
      {
  ...
  },
  {
    id: "tri-ton",
    name: "Huyện Tri Tôn",
    image: "https://statics.vinpearl.com/nui-cam-an-giang-0_1630905070.jpg",
    description: "Huyện Tri Tôn nằm ở phía tây của tỉnh An Giang, là nơi có cụm núi Thất Sơn nổi tiếng với phong cảnh hùng vĩ và nhiều di tích văn hóa lịch sử.",
    attractions: [
      {
  ...
  },
  {
    ...
    description: "Huyện An Phú nằm ở phía đông bắc tỉnh An Giang, giáp với Campuchia và tỉnh Đồng Tháp, nổi tiếng với vùng sông nước và biên giới.",
    attractions: [
      {
  ...
  return (
    <div className="min-h-screen bg-amber-50">
      ...
      <main className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="mb-10">
          <h2 className="text-3xl font-bold text-amber-900 mb-4">Các Huyện, Thị Xã và Thành Phố của An Giang chưa sáp nhập</h2>
          <p className="text-lg text-amber-800">
            An Giang gồm 2 thành phố, 2 thị xã và 7 huyện, mỗi địa phương đều có nét văn hóa, ẩm thực và cảnh quan riêng biệt.
          </p>
        </div>
