    ...
    attractions: [
      {
        ...
        description: "Nằm ở xã An Hảo, Tịnh Biên, núi Cấm được người dân nơi đây ví như nóc nhà của vùng đồng bằng Sông Cửu Long. Không hổ danh là vùng bảy núi, nơi đây sở hữu những khung cảnh thiên nhiên xanh mướt của cây cối tuyệt đẹp. Đến với vùng núi này bạn sẽ được tham quan những kiến trúc đặc sắc và trải nghiệm nhiều hoạt động gần gũi, hòa mình vào thiên nhiên của vùng đất bảy núi hiền hòa.",
