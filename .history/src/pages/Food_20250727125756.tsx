          ...
          <Card className="shadow-md">
            <CardContent className="pt-6">
              <div className="prose lg:prose-lg mx-auto">
                ...
                <p>
                  Ẩm thực An Giang đa dạng như chính cảnh quan và di sản văn hóa của nó. Nằm trong vùng đồng 
                  bằng sông Cửu Long màu mỡ và chịu ảnh hưởng từ nhiều dân tộc như Kinh, Khmer, và Chăm, 
                  tỉnh An Giang mang đến một bức tranh ẩm thực phong phú phản ánh lịch sử và địa lý của vùng đất này.
                </p>
                <p>
                  Với nguồn cá tươi dồi dào từ sông Mekong, những cánh đồng lúa xanh tươi, và các loại trái cây, 
                  rau củ nhiệt đới, ẩm thực An Giang nổi tiếng với sự tươi ngon, cân bằng trong hương vị và 
                  cách sử dụng nguyên liệu địa phương độc đáo. Đặc biệt, các sản phẩm mắm từ Châu Đốc đã 
                  được công nhận trong cả nước.
                </p>
                <p>
                  Dưới đây là những món ăn đặc trưng và ngon nhất của An Giang, được phân loại để giúp bạn 
                  khám phá thiên đường ẩm thực này.
                </p>
              </div>
            </CardContent>
          </Card>
