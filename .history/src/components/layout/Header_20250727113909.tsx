          ...
          <nav className="flex items-center space-x-1 bg-amber-900/50 px-2 py-1 rounded-full backdrop-blur-sm">
            <Link to="/">
              <Button
                ...
                className={`text-amber-50 ${!isActive('/') ? "hover:bg-amber-800/40 hover:text-white" : ""
                  }`}
              >
                Điểm Đến
              </Button>
            ...
            <Link to="/about">
              <Button
                ...
                className={`text-amber-50 ${!isActive('/about') ? "hover:bg-amber-800/40 hover:text-white" : ""
                  }`}
              >
                Giới Thiệu
              </Button>
            ...
            <Link to="/food">
              <Button
                ...
                className={`text-amber-50 ${!isActive('/food') ? "hover:bg-amber-800/40 hover:text-white" : ""
                  }`}
              >
                Ẩm Thực
              </Button>
            ...
            <Link to="/districts">
              <Button
                variant={isActive('/districts') ? "secondary" : "ghost"}
                className={`text-amber-50 ${!isActive('/districts') ? "hover:bg-amber-800/40 hover:text-white" : ""
                  }`}
              >
                Huyện/Thị
              </Button>
