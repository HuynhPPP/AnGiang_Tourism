...
export function Header() {
  ...
  <Link to="/">
    <Button
      ...
      className={`text-amber-50 ${
        !isActive('/') ? "hover:bg-amber-800/40 hover:text-white" : ""
      }`}
    >
      Điểm Đến
    </Button>
  ...
  <Link to="/about">
    <Button
      ...
      className={`text-amber-50 ${
        !isActive('/about') ? "hover:bg-amber-800/40 hover:text-white" : ""
      }`}
    >
      Giới Thiệu
    </Button>
  ...
  <Link to="/food">
    <Button
      ...
      className={`text-amber-50 ${
        !isActive('/food') ? "hover:bg-amber-800/40 hover:text-white" : ""
      }`}
    >
      Ẩm Thực
    </Button>
  ...
  <Link to="/districts">
    <Button
      ...
      className={`text-amber-50 ${
        !isActive('/districts') ? "hover:bg-amber-800/40 hover:text-white" : ""
      }`}
    >
      Huyện/Thị
    </Button>
