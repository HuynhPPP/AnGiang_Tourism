      ...
      <div className='relative z-10 mx-auto max-w-6xl px-3 sm:px-4 py-8 sm:py-10 lg:px-8'>
        <div className='grid gap-6 sm:gap-8 lg:grid-cols-[1.3fr,1fr,1fr]'>
          ...
          <div className='space-y-3 sm:space-y-4 rounded-2xl sm:rounded-3xl border border-white/10 bg-white/5 p-4 sm:p-5 backdrop-blur'>
            ...
            <div className='space-y-2 text-xs sm:text-sm text-amber-50/90'>
              <div className='flex items-center gap-2'>
                ...
                <span className='font-medium text-amber-100'>Tấn Khương</span>
              </div>
              <div className='flex items-center gap-2'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                ...
                <a href='tel:+84944902423' className='hover:text-amber-200 transition-colors'>
                  +84 944 902 423
                </a>
              </div>
              <div className='flex items-center gap-2'>
                ...
                <a href='mailto:tankhuong02@gmail.com' className='hover:text-amber-200 transition-colors'>
                  tankhuong02@gmail.com
                </a>
              </div>
            </div>
          </div>
          ...
          <div className='space-y-3 sm:space-y-4 rounded-2xl sm:rounded-3xl border border-white/10 bg-white/5 p-4 sm:p-5 text-xs sm:text-sm text-amber-50/90 backdrop-blur'>
            ...
            <p>Theo dõi tôi để nhận tin nhanh về lễ hội, thời tiết đẹp và hành trình mới.</p>
            <div className='flex flex-wrap gap-3 sm:gap-4'>
              {[
                {
                  label: 'Facebook',
                  href: 'https://www.facebook.com/huynh.phan.261218/',
                  path: 'M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z',
                },
                {
                  label: 'Instagram',
                  href: 'https://www.instagram.com/huynhphannnnn?igsh=MXBjb3c2OXY5MjUxcg==',
                ...
                <a
                  ...
                  className='text-amber-100 transition hover:text-white hover:scale-110'
                >
            ...
            <p className='text-[0.65rem] sm:text-xs text-emerald-100/70'>
              &copy; 2025 An Giang Tourism
              <a
                href='mailto:tankhuong02@gmail.com'
