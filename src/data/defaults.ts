import type { Destination, FoodCategory, District } from '@/types';
    ...
    foods: [
      {
        ...
        description:
          'Đặc sản của Châu Đốc, gồm bún với cá, rau và gia vị trong nước dùng thơm ngon.',
      },
      {
        name: 'Mắm (Cá lên men)',
  ...
  },
  {
    ...
    attractions: [
      ...
      },
      {
        ...
        description:
          'Khu du lịch sinh thái với núi Voi hùng vĩ, có nhiều hoạt động giải trí và nghỉ dưỡng.',
        image:
          'https://dulichphunu.net/wp-content/uploads/2021/01/nui-voi-min.jpg',
      },
      {
        name: 'Chợ Tịnh Biên',
        description:
          'Chợ biên giới lớn, nơi giao thương hàng hóa giữa Việt Nam và Campuchia, nhiều mặt hàng độc đáo.',
        image:
          'https://vintrip.cdn.vccloud.vn/wp-content/uploads/2017/08/cho-tinh-bien.jpg',
      },
    ],
    cuisine: [
      {
